...
class Center(Expression[str, None]):
    def evaluate(self, s: str, width: int, fillchar: str="") -> str:
        return s.center(width, fillchar)

class Count(Expression[int, None]):
    def evaluate(self, s: str, x: str, start: Optional[int]=None, end: Optional[int]=None) -> int:
        return s.count(x, start, end)

class Encode(Expression[bytes, None]):
    def evaluate(self, s: str, encoding: str="utf-8", errors: str="strict") -> bytes:
        return s.encode(encoding, errors)

class Endswith(Expression[bool, None]):
    def evaluate(self, s: str, suffix: Union[str, Tuple[str, ...]], start: Optional[int]=None, end: Optional[int]=None) -> bool:
        return s.endswith(suffix, start, end)

class Expandtabs(Expression[str, None]):
    def evaluate(self, s: str, tabsize: int=8) -> str:
        return s.expandtabs(tabsize)

class Find(Expression[int, None]):
    def evaluate(self, s: str, sub: str, start: Optional[int]=None, end: Optional[int]=None) -> int:
        return s.find(sub, start, end)

class Format(Expression[str, None]):
    def evaluate(self, s: str, *args: object, **kwargs: object) -> str:
        return s.format(*args, **kwargs)

class FormatMap(Expression[str, None]):
    def evaluate(self, s: str, map: Dict[str, object]) -> str:
...
class Join(Expression[str, None]):
    def evaluate(self, s: str, iterable: Iterable[str]) -> str:
...
class Lstrip(Expression[str, None]):
    def evaluate(self, s: str, chars: Optional[str]=None) -> str:
        return s.lstrip(chars)

class Maketrans(Expression[Union[Dict[int, T], Dict[int, Optional[int]]], None]):
    def evaluate(self, s: str, x: Union[Dict[int, T], Dict[str, T], Dict[Union[int, str], T], str], y: Optional[str]=None, z: Optional[str]=None) -> Union[Dict[int, T], Dict[int, Optional[int]]]:
        if type(x) == dict:
...
class Partition(Expression[Tuple[str, str, str], None]):
    def evaluate(self, s: str, sep: str) -> Tuple[str, str, str]:
        return s.partition(sep)

class Removeprefix(Expression[str, None]):
    def evaluate(self, s: str, sep: str) -> str:
...
class Replace(Expression[str, None]):
    def evaluate(self, s: str, old: str, new: str, count: int=-1) -> str:
...
class Rsplit(Expression[List[str], None]):
    def evaluate(self, s: str, sep: Optional[str]=None, maxsplit: int=-1) -> List[str]:
...
class Split(Expression[List[str], None]):
    def evaluate(self, s: str, sep: Optional[str], maxsplit: int=-1) -> List[str]:
        return s.split(sep, maxsplit)

class Splitlines(Expression[List[str], None]):
    def evaluate(self, s: str, keepends: bool=False) -> List[str]:
        return s.splitlines(keepends)

class Startswith(Expression[bool, None]):
    def evaluate(self, s: str, prefix: Union[str, Tuple[str, ...]], start: Optional[int]=None, end: Optional[int]=None) -> bool:
...
class Translate(Expression[str, None]):
    def evaluate(self, s: str, table: Dict[int, Optional[Union[str, int]]]) -> str:
...
class Zfill(Expression[str, None]):
    def evaluate(self, s: str, width: int) -> str:
