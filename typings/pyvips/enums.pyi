...
Attributes:
    ...
    SOUTH: Literal["south"]
    WEST: Literal["west"]
    NORTH_EAST: Literal["north-east"]
    SOUTH_EAST: Literal["south-east"]
    SOUTH_WEST: Literal["south-west"]
    NORTH_WEST: Literal["north-west"]
...
Attributes:
    ...
    NONE: Literal["none"]
    CENTRE: Literal["centre"]
    ENTROPY: Literal["entropy"]
    ATTENTION: Literal["attention"]
    LOW: Literal["low"]
    HIGH: Literal["high"]
    ALL: Literal["all"]
...
Attributes:
    ...
    NONE: Literal["none"]
    JPEG: Literal["jpeg"]
    DEFLATE: Literal["deflate"]
    PACKBITS: Literal["packbits"]
    CCITTFAX4: Literal["ccittfax4"]
    LZW: Literal["lzw"]
    WEBP: Literal["webp"]
    ZSTD: Literal["zstd"]
    JP2K: Literal["jp2k"]
...
Attributes:
    ...
    CUBIC: Literal["cubic"]
    MITCHELL: Literal["mitchell"]
    LANCZOS2: Literal["lanczos2"]
    LANCZOS3: Literal["lanczos3"]
...
Attributes:
    ...
    RGB: Literal["rgb"]
    RGBA: Literal["rbga"]
    RGBA_ONLY: Literal["rgba_only"]
    RGB_CMYK: Literal["rgb_cmyk"]
    ANY: Literal["any"]
...
Attributes:
    ...
    ERROR: Literal["error"]
    NONE: Literal["none"]
    SETBUF: Literal["setbuf"]
    SETBUF_FOREIGN: Literal["setbuf_foreign"]
    OPENIN: Literal["openin"]
    MMAPIN: Literal["mmapin"]
    MMAPINRW: Literal["mmapinrw"]
    OPENOUT: Literal["openout"]
